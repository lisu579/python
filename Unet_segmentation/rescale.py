...
if __name__ == "__main__":
    source_file = r"D:\STUDY\data\road\validation\output"
    target_file = r"D:\STUDY\data\road\validation\output1"
    resampling(source_file, target_file, scale=1.46484374999994)
