...
def scatter_out_1(x,y): ## x,y为两个需要做对比分析的两个量。
    ...
    plt.xlabel('VOD',family = 'Times New Roman')
    plt.ylabel('Height',family = 'Times New Roman')
    ...
    plt.savefig(r'D:\STUDY\data\VOD\correlation\cor.png',dpi=800,bbox_inches='tight',pad_inches=0)
    plt.show()