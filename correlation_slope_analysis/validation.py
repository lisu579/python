...
'''
        ...
        if d:
            ...
            outputFile_d = self.dataDir_out + os.sep + "data_" + self.period[0] + "_" + self.period[arcpy] + "_days.csv"
...
if __name__ == "__main__":
    ...
    dataDir_out = r"D:\STUDY\data\meteology\validation"
    # dataDir_stations = rootDir + os.sep + r"D:\STUDY\data\meteology\00_20"

    sidArr = ["57780", "57853"]  # 站号列表
    fields = ["EVP"]  # 可选的提取变量列表
